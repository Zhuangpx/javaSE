 ...
 * @LastEditTime: 2021-09-10 17:03:47
...
class People {
    ...
    void speak() {
        ...
        System.out.println("My age :" + age );//带换行输出
...
public class example3_4 {
    public static void main(String args[]) {
        ...
        People zpx = new People();//创造对象zpx

        Scanner reader = new Scanner(System.in);//创造对象读取输入
        System.out.println("Input age:");

        zpx.age = reader.nextInt();//方法调用
        System.out.println("Input werght:");

        zpx.weight = reader.nextFloat();//方法调用
        zpx.speak();
    }
}